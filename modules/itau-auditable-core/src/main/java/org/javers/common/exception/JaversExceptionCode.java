...
public enum JaversExceptionCode {
    ...
    TRANSACTION_MANAGER_NOT_SET("Can't create javers bean due to missing configuration. Since itau-auditable-spring 2.8.0, transactionManager bean should be explicitly provided in TransactionalJaversBuilder.withTxManager(). See example at http://javers.org/documentation/spring-integration/#spring-jpa-example")
    ;
