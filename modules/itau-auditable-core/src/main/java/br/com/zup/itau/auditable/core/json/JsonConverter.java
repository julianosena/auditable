...
import br.com.zup.itau.auditable.core.json.typeadapter.commit.CdoSnapshotAssembler;
...
/**
 * ItauAuditable is meant to support various persistence stores for
 * any kind of client's data, hence we use JSON format to serialize/deserialize client's domain objects.
 * <br><br>
 *
 * ItauAuditable uses <a href='http://sites.google.com/site/gson/'>Gson</a>
 ...
 * <br><br>
 *
 * If so, you can easily customize ItauAuditable serialization/deserialization behaviour
 * by providing plugins for each of your custom type.
 * ItauAuditable accepts several kind of plugins:
 * <ul>
 ...
 *           For concrete class example see {@link br.com.zup.itau.auditable.java8support.LocalDateTimeTypeAdapter}.
 ...
 * </ul>
 *
 * ItauAuditable provides JsonTypeAdapters for some well known Values like java.time.LocalDateTime,
