...
class InstanceIdFactory {
    ...
    String localIdAsString(ItauAuditableProperty idProperty, Object dehydratedAtomicLocalId) {
    ...
    private ItauAuditableException idTypeNotSupported() {
        return new ItauAuditableException(ItauAuditableExceptionCode.ID_TYPE_NOT_SUPPORTED,
    ...
    Type getLocalIdDehydratedType() {
        ...
        ItauAuditableProperty idProperty = entityType.getIdProperty();
    ...
    private Object dehydratedLocalId(ItauAuditableProperty idProperty, Object localId) {
        if (idProperty.isEntityType()) {
            EntityType idPropertyType = idProperty.getType();
