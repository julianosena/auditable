...
import static br.com.zup.itau.auditable.common.validation.Validate.*;
...
public abstract class Change implements Serializable {
     ...
     * Not available for Changes read from ItauAuditableRepository
     */
    ...
    /**
     * Empty if change is calculated by {@link ItauAuditable#compare(Object, Object)}
     */
