...
class ValueChangeTypeAdapter extends ChangeTypeAdapter<ValueChange> {
    ...
    public ValueChange fromJson(JsonElement json, JsonDeserializationContext context) {
        ...
        Object leftValue  = context.deserialize(jsonObject.get(LEFT_VALUE_FIELD),  getItauAuditableProperty(stub).getGenericType());
        Object rightValue = context.deserialize(jsonObject.get(RIGHT_VALUE_FIELD), getItauAuditableProperty(stub).getGenericType());
