...
import br.com.zup.itau.auditable.common.reflection.ArgumentResolver;
...
public class ContainerArgumentResolver implements ArgumentResolver {
    ...
    public Object resolve(Class argType) {
        ...
        if (component == null) {
            ...
            throw new ItauAuditableException(ItauAuditableExceptionCode.COMPONENT_NOT_FOUND, argType.getName());
        }
