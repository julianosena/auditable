...
import br.com.zup.itau.auditable.core.model.SnapshotEntity.DummyEnum
...
class ItauAuditableRepositoryE2ETest extends Specification {
    ...
    def "should store state history of Entity in ItauAuditableRepository"() {
        given:
    ...
    def "should persist commits in multiple-instances environment"(){
        ...
        withPool threads, {
            (1..threads).collectParallel {
                def jv = buildNextItauAuditableInstance(repository)
