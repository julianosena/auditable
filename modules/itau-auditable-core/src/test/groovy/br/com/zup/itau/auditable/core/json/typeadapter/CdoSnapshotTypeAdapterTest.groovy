...
import br.com.zup.itau.auditable.core.GlobalIdTestBuilder
...
import br.com.zup.itau.auditable.core.json.typeadapter.commit.CdoSnapshotStateTypeAdapter
...
class CdoSnapshotTypeAdapterTest extends Specification {
    ...
    def "should serialize state with entity in CdoSnapshot"() {
        ...
        then:
        def json = new JsonSlurper().parseText(jsonText)
        json.state.dummyUserDetails.entity == "br.com.zup.itau.auditable.core.model.DummyUserDetails"
    }
    ...
    def "should serialize & deserialize state with Multimaps in CdoSnapshots"() {
        ...
        jsonMultimap == [
                [key:'NY', value: [entity: 'br.com.zup.itau.auditable.core.model.SnapshotEntity', cdoId: 2]],
                [key:'NY', value: [entity: 'br.com.zup.itau.auditable.core.model.SnapshotEntity', cdoId: 3]]
        ]
        ...
        json {
            ...
            state {
                ...
                dummyUserDetailsList ids.collect {
                        id -> [entity: "br.com.zup.itau.auditable.core.model.DummyUserDetails", cdoId: id]
                }
