...
import static br.com.zup.itau.auditable.repository.jql.UnboundedValueObjectIdDTO.unboundedValueObjectId
import static br.com.zup.itau.auditable.repository.jql.ValueObjectIdDTO.withUnboundedValueObjectOwner
...
abstract class ObjectGraphBuilderTest extends Specification {
    ...
    def "should build graph from nested ValueObjects"(){
      ...
      NodeAssert.assertThat(node)
                ...
                .andTargetNode()
                .hasValueObjectId("br.com.zup.itau.auditable.core.model.CategoryVo/#parent")
                .and()
                .hasSingleEdge("parent")
                .andTargetNode()
                .hasValueObjectId("br.com.zup.itau.auditable.core.model.CategoryVo/#parent/parent")
                .hasOwnerId("br.com.zup.itau.auditable.core.model.CategoryVo/")
                . and()
                .hasSingleEdge("parent")
                .andTargetNode()
                .hasValueObjectId("br.com.zup.itau.auditable.core.model.CategoryVo/#parent/parent/parent")
                .hasOwnerId("br.com.zup.itau.auditable.core.model.CategoryVo/")
    ...
    def "should build graph with #containerType<#managedType> MultiEdge"() {
        ...
        then:
        NodeAssert.assertThat(node).hasMultiEdge(propertyName).ofSize(2)
    ...
    def "should assign proper indexes to ValueObjects in List multi edge"() {
        ...
        then:
        NodeAssert.assertThat(node).hasMultiEdge("addressList").refersToGlobalIds(
    ...
    def "should support cycles on unbounded ValueObjects"() {
        ...
        then:
        NodeAssert.assertThat(node).hasGlobalId(unboundedValueObjectId(CategoryVo))
        NodeAssert.assertThat(node).hasMultiEdge("children").refersToGlobalIds([
                withUnboundedValueObjectOwner(CategoryVo, "children/0"),
                withUnboundedValueObjectOwner(CategoryVo, "children/1")
        ])
        NodeAssert.assertThat(node).hasMultiEdge("children")
                        .andFirstTargetNode()
    ...
    def "should support large graphs (more than 10000 edges)"() {
        ...
        (10000-1).times {
            ...
            NodeAssert.assertThat(node).hasMultiEdge("categories")
            NodeAssert.assertThat(node).hasSingleEdge("parent")
        }
    ...
    def "should build graph with Optional<#managedType> SingleEdge"() {
        ...
        then:
        NodeAssert.assertThat(node).hasMultiEdge(propertyName).ofSize(1)
