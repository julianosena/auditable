 ...
 */
public class ItauAuditableSchemaManager extends SchemaNameAware {
    private static final Logger logger = LoggerFactory.getLogger(ItauAuditableSchemaManager.class);
    ...
    public ItauAuditableSchemaManager(Dialect dialect, FixedSchemaFactory schemaFactory, PolyJDBC polyJDBC, ConnectionProvider connectionProvider, TableNameProvider tableNameProvider) {
    ...
    public void ensureSchema() {
        ...
        alterCommitIdColumnIfNeeded(); // Itaú Auditable 2.5 to 2.6 schema migration
