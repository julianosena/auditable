...
import br.com.zup.itau.auditable.repository.sql.finders.MultitenancySnapshotQuery.SnapshotDbIdentifier;
import br.com.zup.itau.auditable.repository.sql.repositories.MultitenancyGlobalIdRepository;
...
public class MultitenancyCdoSnapshotFinder {

    private final MultitenancyGlobalIdRepository globalIdRepository;
    private final MultitenancyCommitPropertyFinder commitPropertyFinder;
    ...
    public MultitenancyCdoSnapshotFinder(MultitenancyGlobalIdRepository globalIdRepository, MultitenancyCommitPropertyFinder commitPropertyFinder, MultitenancyTableNameProvider tableNameProvider) {
    ...
    private List<CdoSnapshot> fetchCdoSnapshots(Consumer<MultitenancySnapshotQuery> additionalFilter,
                                                QueryParams queryParams, Session session) {
        MultitenancySnapshotQuery query = new MultitenancySnapshotQuery(tableNameProvider, queryParams, session);
