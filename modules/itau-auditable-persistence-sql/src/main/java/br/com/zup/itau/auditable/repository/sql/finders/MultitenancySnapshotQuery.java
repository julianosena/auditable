...
import br.com.zup.itau.auditable.repository.sql.session.ObjectMapper;
import br.com.zup.itau.auditable.repository.sql.session.Parameter;
...
import static br.com.zup.itau.auditable.repository.sql.session.Parameter.*;

class MultitenancySnapshotQuery {
    ...
    public MultitenancySnapshotQuery(MultitenancyTableNameProvider tableNames, QueryParams queryParams, Session session) {
