...
import br.com.zup.itau.auditable.repository.sql.repositories.MultitenancyCdoSnapshotRepository;
import br.com.zup.itau.auditable.repository.sql.repositories.MultitenancyCommitMetadataRepository;
import br.com.zup.itau.auditable.repository.sql.repositories.MultitenancyGlobalIdRepository;
import br.com.zup.itau.auditable.repository.sql.schema.MultitenancyItauAuditableSchemaManager;
...
public class MultitenancyItauAuditableSqlRepository implements ItauAuditableRepository {
    ...
    private final MultitenancyItauAuditableSchemaManager schemaManager;

    private final SqlRepositoryConfiguration sqlRepositoryConfiguration;

    public MultitenancyItauAuditableSqlRepository(SessionFactory sessionFactory,
                                           ...
                                           MultitenancyItauAuditableSchemaManager schemaManager,
