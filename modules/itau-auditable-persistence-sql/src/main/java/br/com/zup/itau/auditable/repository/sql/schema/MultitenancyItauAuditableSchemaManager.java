...
import static br.com.zup.itau.auditable.repository.sql.schema.FixedSchemaFactory.COMMIT_COMMIT_DATE_INSTANT;
import static br.com.zup.itau.auditable.repository.sql.schema.FixedSchemaFactory.GLOBAL_ID_OWNER_ID_FK;

public class MultitenancyItauAuditableSchemaManager extends MultitenancySchemaNameAware {
    private static final Logger logger = LoggerFactory.getLogger(MultitenancyItauAuditableSchemaManager.class);

    private SchemaInspector schemaInspector;
    private SchemaManager schemaManager;
    private final Dialect dialect;
    private final MultitenancySchemaFactory schemaFactory;
    private final PolyJDBC polyJDBC;
    private final ConnectionProvider connectionProvider;

    public MultitenancyItauAuditableSchemaManager(Dialect dialect, MultitenancySchemaFactory schemaFactory, PolyJDBC polyJDBC, ConnectionProvider connectionProvider, MultitenancyTableNameProvider tableNameProvider) {
    ...
    private void addDbIndexOnOwnerId() {
        ...
        addIndex(getGlobalIdTableName(), new MultitenancySchemaFactory.IndexedCols(GLOBAL_ID_OWNER_ID_FK));
    }
     ...
     */
    @Deprecated
    private void addIndex(MultitenancyDBObjectName tableName, MultitenancySchemaFactory.IndexedCols indexedCols) {
