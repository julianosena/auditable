...
import br.com.zup.itau.auditable.repository.sql.session.KeyGenerator.SequenceAllocation;
...
public class Session implements AutoCloseable {
    public static final String SQL_LOGGER_NAME = "br.com.zup.itau.auditable.SQL";
