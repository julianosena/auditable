...
public class JaversMultiTenancySchemaManager extends SchemaNameAware {
    ...
    public JaversMultiTenancySchemaManager(Dialect dialect, FixedSchemaFactory schemaFactory, PolyJDBC polyJDBC, ConnectionProvider connectionProvider, TableNameProvider tableNameProvider) {
...
//        }
    ...
    private void alterCommitIdColumnIfNeeded() {
        JaversSchemaManager.ColumnType commitIdColType = getTypeOf(getCommitTableNameWithSchema(), "commit_id");
...
//        JaversSchemaManager.ColumnType stateColType = getTypeOf(getSnapshotTableNameWithSchema(), "state");
//        JaversSchemaManager.ColumnType changedPropertiesColType = getTypeOf(getSnapshotTableNameWithSchema(), "state");
//
...
//    }
    ...
    private JaversSchemaManager.ColumnType getTypeOf(String tableName, String colName) {
        try {
            Statement stmt = connectionProvider.getConnection().createStatement();
            ...
            return new JaversSchemaManager.ColumnType(colType, colPrec, colTypeName);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    private void alterMySqlCommitDateColumn() {
        JaversSchemaManager.ColumnType commitDateColType = getTypeOf(getCommitTableNameWithSchema(), "commit_date");
    ...
    private void extendStringColumnIfNeeded(String tableName, String colName, int len) {
        JaversSchemaManager.ColumnType colType = getTypeOf(tableName, colName);
