...
import org.javers.repository.sql.schema.JaversMultiTenancySchemaManager;
...
public class JaversMultiTenancySqlRepository implements JaversRepository {

    private final JaversMultiTenancySchemaManager schemaManager;

    JaversMultiTenancySqlRepository(JaversMultiTenancySchemaManager schemaManager) {
