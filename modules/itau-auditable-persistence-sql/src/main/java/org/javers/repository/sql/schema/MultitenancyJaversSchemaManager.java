...
public class MultitenancyJaversSchemaManager extends MultitenancySchemaNameAware {
    ...
    public MultitenancyJaversSchemaManager(Dialect dialect, MultitenancySchemaFactory schemaFactory, PolyJDBC polyJDBC, ConnectionProvider connectionProvider, MultitenancyTableNameProvider tableNameProvider) {
