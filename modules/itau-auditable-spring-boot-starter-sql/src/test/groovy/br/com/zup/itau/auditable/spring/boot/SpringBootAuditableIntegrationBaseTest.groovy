...
abstract class SpringBootAuditableIntegrationBaseTest extends Specification {
    ...
    def "@ItauAuditableSpringDataAuditable aspect should work effortlessly with spring-boot"(){
        given:
    ...
    def "@ItauAuditableSpringDataAuditable aspect should work when Ids are generated by Hibernate"() {
