...
import br.com.zup.itau.auditable.common.string.RegexEscape;
import br.com.zup.itau.auditable.common.validation.Validate;
import br.com.zup.itau.auditable.core.CommitIdGenerator;
...
import br.com.zup.itau.auditable.repository.api.*;
import br.com.zup.itau.auditable.repository.mongo.model.MongoHeadId;

import java.util.*;
import java.util.stream.Collectors;

import static br.com.zup.itau.auditable.common.collections.Lists.toImmutableList;
import static br.com.zup.itau.auditable.common.validation.Validate.conditionFulfilled;
import static br.com.zup.itau.auditable.repository.mongo.DocumentConverter.fromDocument;
import static br.com.zup.itau.auditable.repository.mongo.DocumentConverter.toDocument;
import static br.com.zup.itau.auditable.repository.mongo.MongoDialect.DOCUMENT_DB;
import static br.com.zup.itau.auditable.repository.mongo.MongoDialect.MONGO_DB;
import static br.com.zup.itau.auditable.repository.mongo.MongoSchemaManager.*;

public class MultitenancyMongoRepository implements ItauAuditableRepository, ConfigurationAware {
    ...
    @Override
    public void setConfiguration(ItauAuditableCoreConfiguration coreConfiguration) {
